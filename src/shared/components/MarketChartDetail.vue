  ...
  <div class="container">
      ...
      <div class="content">
        ...
        <div class="subtitle">
          <div class="text-value">
            {{ $_.get(this.buyIn, "value", 0) }}
            {{ $_.get(this.buyIn, "unit", "") }}
          </div>
    ...
    <div class="current-value-container">
      ...
      <div class="content">
        ...
        <div class="subtitle">
          <div class="text-value">
            {{ $_.get(this.currentValue, "value", 0) }}
            {{ $_.get(this.currentValue, "unit", "") }}
          </div>
...
import { formatCurrencyZeroFaction } from "@/utils/common.utils";
